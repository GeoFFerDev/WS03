                ...
                <article class="job-card">
                    <div class="job-card-content">
                        <div class="job-card-top" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.75rem;">
                            <span class="job-card-category" style="font-weight: 600; color: var(--primary-color, #10b981);"><?= sanitize($listing->company ?? 'Company') ?></span>
                        ...
                        <div class="job-card-meta" style="border-top: 1px solid #f3f4f6; padding-top: 1rem; margin-bottom: 1.25rem;">
                            <div class="job-meta-row">
                                ...
                                <span class="job-salary" style="font-weight: 600; color: #10b981;"><?= formatSalary($listing->salary) ?></span>
                            </div>
                            <div class="job-meta-row">
